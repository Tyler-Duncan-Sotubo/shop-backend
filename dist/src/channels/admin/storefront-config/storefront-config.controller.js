...
const base_theme_admin_service_1 = require("../../../domains/storefront-config/services/base-theme-admin.service");
const storefront_override_service_1 = require("../../../domains/storefront-config/services/storefront-override.service");
...
let StorefrontConfigController = class StorefrontConfigController extends base_controller_1.BaseController {
    ...
    async getStoreThemeStatus(user, storeId) {
...
__decorate([
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, common_1.Get)('admin/stores/:storeId/theme-status'),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('storeId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], StorefrontConfigController.prototype, "getStoreThemeStatus", null);
