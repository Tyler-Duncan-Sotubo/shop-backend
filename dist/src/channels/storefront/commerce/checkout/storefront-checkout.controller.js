...
const complete_checkout_dto_1 = require("./dto/complete-checkout.dto");
...
const checkout_payment_service_1 = require("../../../../domains/commerce/checkout/checkout-payment.service");
const cart_token_guard_1 = require("../../common/guard/cart-token.guard");
...
__decorate([
    ...
    __param(3, (0, common_1.Ip)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, complete_checkout_dto_1.CompleteCheckoutDto, String]),
    __metadata("design:returntype", void 0)
], StorefrontCheckoutController.prototype, "complete", null);
__decorate([
    (0, common_1.UseGuards)(cart_token_guard_1.CartTokenGuard),
    (0, common_1.Post)(':checkoutId/sync'),
    __param(0, (0, current_company_id_decorator_1.CurrentCompanyId)()),
    __param(1, (0, common_1.Param)('checkoutId')),
    __param(2, (0, common_1.Ip)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], StorefrontCheckoutController.prototype, "sync", null);
__decorate([
    (0, common_1.UseGuards)(cart_token_guard_1.CartTokenGuard),
    (0, common_1.Post)(':checkoutId/refresh'),
    __param(0, (0, current_company_id_decorator_1.CurrentCompanyId)()),
    __param(1, (0, common_1.Param)('checkoutId')),
    __param(2, (0, current_store_decorator_1.CurrentStoreId)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], StorefrontCheckoutController.prototype, "refresh", null);
__decorate([
