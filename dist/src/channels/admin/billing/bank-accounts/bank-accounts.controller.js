...
const company_bank_accounts_service_1 = require("../../../../domains/billing/company-bank-accounts/company-bank-accounts.service");
...
let BankAccountsController = class BankAccountsController extends base_controller_1.BaseController {
    constructor(service) {
        super();
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, update_bank_account_dto_1.UpdateBankAccountDto]),
    __metadata("design:returntype", Promise)
...
exports.BankAccountsController = BankAccountsController = __decorate([
    (0, common_1.Controller)('billing/bank-accounts'),
