...
import { orders } from 'src/infrastructure/drizzle/schema'; // or wherever you export it
import { orderItems } from 'src/infrastructure/drizzle/schema'; // or wherever you export it
