...
exports.VerifyLoginDto = exports.RequestPasswordResetDto = exports.TokenDto = void 0;
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'Temporary Token is required.' }),
    __metadata("design:type", String)
], VerifyLoginDto.prototype, "tempToken", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
