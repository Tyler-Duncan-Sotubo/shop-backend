...
let AuditController = class AuditController extends base_controller_1.BaseController {
    ...
    async getAuthenticationLogs(user) {
...
__decorate([
    (0, common_1.Get)('logs'),
    (0, common_1.SetMetadata)('permissions', ['audit.logs.read']),
...
__decorate([
    (0, common_1.Get)('authentication-logs'),
    (0, common_1.SetMetadata)('permissions', ['audit.auth.read']),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], AuditController.prototype, "getAuthenticationLogs", null);
