...
import { StorePaymentMethodsService } from '../services/payment-methods.service';
import { ToggleStorePaymentMethodDto, UpsertBankTransferConfigDto, UpsertGatewayConfigDto } from '../dto/payment-methods.dto';
export declare class StorePaymentMethodsController extends BaseController {
    private readonly storeMethods;
    constructor(storeMethods: StorePaymentMethodsService);
