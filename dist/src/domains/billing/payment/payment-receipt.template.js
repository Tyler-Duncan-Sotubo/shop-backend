...
exports.paymentReceiptThermalTemplate = paymentReceiptThermalTemplate;
exports.paymentReceiptThermalCss = paymentReceiptThermalCss;
function paymentReceiptThermalTemplate() {
    return `
  <div class="rct">
    <div class="center">
      {{#if branding.logoUrl}}
...
function paymentReceiptThermalCss() {
    return `
