export declare const quoteRequests: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        createdZohoAt: import("drizzle-orm/pg-core").PgColumn<{
            name: "created_zoho_at";
            tableName: "quote_requests";
            dataType: "date";
            columnType: "PgTimestamp";
            data: Date;
        ...
        totalsSnapshot: import("drizzle-orm/pg-core").PgColumn<{
            name: "totals_snapshot";
            tableName: "quote_requests";
            dataType: "json";
            columnType: "PgJsonb";
            data: {
...
export declare const quoteCounters: import("drizzle-orm/pg-core").PgTableWithColumns<{
    name: "quote_counters";
    schema: undefined;
    columns: {
        id: import("drizzle-orm/pg-core").PgColumn<{
            name: "id";
            tableName: "quote_counters";
            dataType: "string";
            columnType: "PgUUID";
            data: string;
            driverParam: string;
