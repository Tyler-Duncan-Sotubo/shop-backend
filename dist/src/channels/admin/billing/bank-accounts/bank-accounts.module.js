...
const company_bank_accounts_module_1 = require("../../../../domains/billing/company-bank-accounts/company-bank-accounts.module");
...
exports.BankAccountsModule = BankAccountsModule = __decorate([
    (0, common_1.Module)({
        imports: [company_bank_accounts_module_1.CompanyBankAccountsModule],
