...
exports.requestDispatchHtml = void 0;
const requestDispatchHtml = (d) => `
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
  ...
  <body style="margin: 0; padding: 0; background-color: #f5f7f9; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, Helvetica, sans-serif; color: #0f172a;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden; opacity: 0; color: transparent;">
      Order ${d.orderNumber} is ready for dispatch — action required.
    </div>
          ...
          <table width="640" cellpadding="0" cellspacing="0" style="width: 100%; max-width: 640px; background-color: #ffffff; border-radius: 14px; overflow: hidden; border: 1px solid #eef2f6; box-shadow: 0 10px 30px rgba(15, 23, 42, 0.08);">
            ...
            <tr>
              <td style="padding: 6px 26px 0 26px">
                <div style="font-size: 20px; font-weight: 700; letter-spacing: -0.2px;">Action Required — Dispatch Order</div>
                <div style="margin-top: 6px; font-size: 13px; color: #64748b; line-height: 1.6;">
                  A new dispatch request has been submitted and is awaiting your confirmation.
                </div>
              </td>
            </tr>
    ...
    : ''}
                  ...
                  <tr style="border-top: 1px solid #eef2f6; background-color: #f8fafc;">
                    <td style="padding: 12px 16px; font-size: 13px; color: #64748b;">Requested By</td>
                    <td style="padding: 12px 16px; font-size: 13px; font-weight: 600; color: #0f172a;">${d.requestedBy ?? '—'}</td>
                  </tr>
            ...
            <tr>
              <td align="center" style="padding: 24px 26px 0 26px;">
                <div style="font-size: 13px; color: #64748b;">
                  Please log in to the dashboard to confirm or review this dispatch request.
                </div>
              </td>
            </tr>
...
`;
exports.requestDispatchHtml = requestDispatchHtml;
//# sourceMappingURL=request-dispatch.html.js.map