...
exports.renderCampaignTemplate = renderCampaignTemplate;
function renderCampaignTemplate(templateType, content, config) {
    const body = (() => {
        switch (templateType) {
            case 'new_arrival':
...
function wrapWithLayout(body, config) {
    return `
<!DOCTYPE html>
<html>
<head>
...
function renderNewArrival(content) {
    return `
...
function renderPromotion(content) {
